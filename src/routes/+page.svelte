...
<section class="flex flex-col items-center gap-2 px-4 pt-8 min-h-screen">
	<h1 class="text-3xl font-bold leading-tight md:text-5xl lg:leading-[1.1]">
		...
		<div class="invert px-1" style="display:inline-block">
			<a href="https://github.com/gursheyss/download-aio" target="_blank" rel="noopener noreferrer" aria-label="Visit Download AIO on Github">
				...
				<div class="flex items-center space-x-2 justify-start pl-3 dark">
					<RadioGroup bind:value={format}>
						<div class="flex items-center space-x-2">
							<RadioGroupItem value="mp3" id="mp3" aria-label="Select to download in mp3 format" />
							<Label for="mp3">mp3</Label>
						</div>
						<div class="flex items-center space-x-2">
							<RadioGroupItem value="mp4" id="mp4" aria-label="Select to download in mp4 format" />
